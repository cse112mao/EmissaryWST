              ...
              a.ontouchmove =
                function(c, b) {
                  ...
                  if (a.rail.drag && 2 == a.rail.drag.pt) {
                    ...
                    var h = c.clientY + ofy, n = h - a.rail.drag.y, k = c.clientX + f, u = k - a.rail.drag.x,
                      g = a.rail.drag.st - n;
...
(function(a, b) {
  ...
  var b = /\S/, c = /\"/g, d = /\n/g, e = /\r/g, f = /\\/g,
    g = {"#": 1, "^": 2, "/": 3, "!": 4, ">": 5, "<": 6, "=": 7, _v: 8, "{": 9, "&": 10};
  a.scan = function(c, d) {
    function w() {
      p.length > 0 && (q.push(String(p)), p = "")
    }
    ...
    var e = c.length, f = 0, k = 1, l = 2, m = f, n = null, o = null, p = "", q = [], r = !1, s = 0, t = 0, u = "{{",
      v = "}}";
